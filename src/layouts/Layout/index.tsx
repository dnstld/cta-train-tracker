...
const Layout: React.FC = ({ children }) => (
  <div className="w-screen min-h-screen flex flex-col items-center bg-gray-100 pt-20">
    <nav className="fixed top-0 left-0 w-full flex flex-col items-center bg-gray-700 text-gray-50 p-4">
    ...
    <main className="flex-1 w-full max-w-screen-xl p-4">{children}</main>
